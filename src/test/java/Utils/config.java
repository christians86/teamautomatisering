...
public class config {
    ...
    public static final String bildelink_image="//a[contains(text(),'Image')]";
    public static final String bildelink_newface="//a[contains(text(),'New Face')]";
    public static final String bildelink_development="//a[contains(text(),'Development')]";
    public static final String bildelink_mainboard="//a[contains(text(),'Mainboard')]";
    public static final String modellsearch_forside="//a[contains(text(),'Search models')]";
    ...
    //Join_us_sub_page
    public static final String fornavn="input_1_12_3";
    public static final String etternavn="input_1_12_6";
    public static final String by="input_1_22";
    public static final String nasjonalitet="input_1_7";
